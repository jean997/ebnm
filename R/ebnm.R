...
ebnm_workhorse <- function(x,
  ...
  if (prior_family == "point_normal") {
    retlist <- parametric_workhorse(x = x,
                                    ...
                                    call = call,
                                    ...)
  } else if (prior_family == "point_normal_enrichment") {
    retlist <- parametric_workhorse(x = x,
                                    s = s,
                                    annot = annot,
                                    mode = mode,
                                    ...
                                    optmethod = optmethod,
                                    control = control,
                                    checkg_fn = pne_checkg,
                                    initpar_fn = pne_initpar,
                                    scalepar_fn = pn_scalepar,
                                    precomp_fn = pne_precomp,
                                    nllik_fn = pne_nllik,
                                    postcomp_fn = pne_postcomp,
                                    summres_fn = pne_summres,
                                    partog_fn = pne_partog,
                                    postsamp_fn = pne_postsamp,
                                    call = call,
                                    ...)
